...
MainFrame::MainFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_bpButton1 = new wxBitmapButton( m_panel5, wxID_ANY, wxBitmap( wxT("wxWidgetsResources/button_place_holder.bmp"), wxBITMAP_TYPE_ANY ), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
	
	m_bpButton1->SetBitmapDisabled( wxBitmap( wxT("wxWidgetsResources/button_place_holder.bmp"), wxBITMAP_TYPE_ANY ) );
